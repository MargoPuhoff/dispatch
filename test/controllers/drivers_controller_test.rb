...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create driver' do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { email: @driver.email, name: @driver.name, phone: @driver.phone } }
    end
  ...
  test 'should update driver' do
    patch driver_url(@driver), params: { driver: { email: @driver.email, name: @driver.name, phone: @driver.phone } }
