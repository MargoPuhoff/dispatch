...
class DispatchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dispatcher" do
    assert_difference("Dispatcher.count") do
      post dispatchers_url, params: { dispatcher: { email: @dispatcher.email, name: @dispatcher.name, password: @dispatcher.password, phone: @dispatcher.phone } }
    end
  ...
  test "should update dispatcher" do
    patch dispatcher_url(@dispatcher), params: { dispatcher: { email: @dispatcher.email, name: @dispatcher.name, password: @dispatcher.password, phone: @dispatcher.phone } }
